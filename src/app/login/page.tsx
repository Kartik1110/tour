...
import GoogleLoginButton from '@/app/components/google-btn'

export default function LoginPage() {
    return (
        <div className='h-screen w-full flex flex-col justify-center items-center'>
            <h1 className='text-2xl p-4'>Login to get started!</h1>
            <div className="card w-96 bg-base-100 shadow-xl p-10">
                <form className='flex flex-col space-y-4'>
                    ...
                    <label className="input input-bordered flex items-center gap-2">
                        ...
                        <input id="password" name="password" type="password" placeholder='Password' className="grow" />
                    </label>
